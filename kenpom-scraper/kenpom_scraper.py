...
def main():
  ...
  parser.add_argument("-y", "--year", type=int, help="Year to fetch data for (most recent is fetched if omitted).")
  args = parser.parse_args()
  JsonFileWriter(args.output_file, BeautifulSoupHtmlParser(KenpomHttpApi(args.year)).getKenpomData()).writeOutput()

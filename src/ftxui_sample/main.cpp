...
// configuration step. It creates a namespace called `MarchMadnessPicker`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", MarchMadnessPicker::cmake::project_name, MarchMadnessPicker::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", MarchMadnessPicker::cmake::project_version);
      return EXIT_SUCCESS;
    }
